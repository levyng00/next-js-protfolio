    ...
    <Section className="h-screen  flex items-center ">
      ...
      <div className="">
        <div className=" flex flex-col gap-7 text-xl p-2">
          ...
          <div className="">
            <button className="border border-purple-500 w-[150px] rounded-lg p-2 py-4 absolute z-10 bg-black hover:translate-x-1  hover:-translate-y-2 transition-transform">
              Resume!
            </button>
